...
public class serveltLogin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet serveltLogin</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet serveltLogin at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("EGJM".equals(user) && "1234".equals(pass)){
            ...
            request.getRequestDispatcher("index.jsp").forward(request, response); //Le indico donde le mando la variable
            response.sendRedirect("index.jsp"); //redirigir a la misma pagina 
        }
    }
